    ...
    public class InstructionsController : ControllerBase
    {
        ...
        public IActionResult SyncNamesWithDB()
        {
            try
            {
                ...
                List<Tuple<string, string>> names_and_BirthDate = example.GetNames(example.GetConnectionString()); //ÃÓÊÂÚ Á‡ÏÂÌËÚ¸ GetconnectionString Ì‡ ÔÂÂÏÂÌÌÛ˛ ËÎË ÔÂÂÏÂÒÚËÚ¸ ÙÛÌÍˆË˛ ‚ ˝ÚÓÚ Ù‡ÈÎ?
