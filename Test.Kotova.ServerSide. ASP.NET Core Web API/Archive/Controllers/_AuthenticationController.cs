...
{
    public class _AuthenticationController : ControllerBase
    {
        private readonly _LegacyAuthenticationService _legacyAuthService;
        private readonly IConfiguration _configuration;
        private readonly ApplicationDbContextUsers _context;
        private readonly _ChiefsManager _chiefsManager;
        private readonly _JWTTokenValidator _jwtTokenValidator;
        public _AuthenticationController(_LegacyAuthenticationService legacyAuthService, IConfiguration configuration, ApplicationDbContextUsers context, _ChiefsManager chiefsManager, _JWTTokenValidator jwtTokenValidator)
        {
        ...
        public async Task<IActionResult> ChangeCredentials([FromBody] UserCredentials credentials)
        {
            ...
            _CredentialValidation credentialValidation = new _CredentialValidation();
